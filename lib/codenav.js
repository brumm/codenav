...
export default {
  ...
  activate() {
    ...
    this.subscriptions = new CompositeDisposable(
      ...
      atom.workspace.observeTextEditors(editor =>
        editor.onDidChangeCursorPosition(({ newBufferPosition }) => this.updateCursorPosition(editor, newBufferPosition))
      ),
  ...
  updateCursorPosition(editor, newBufferPosition) {
    STATE.cursorPosition = editor.getBuffer().characterIndexForPosition(newBufferPosition)
  },
